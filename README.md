...
* [JSFuck](https://github.com/aemkei/jsfuck) ⭐ 8,559 | 🐛 38 | 🌐 JavaScript | 📅 2025-03-10 - Esoteric programming style based on the atomic parts of JavaScript.
* [Vigil](https://github.com/munificent/vigil) ⭐ 3,020 | 🐛 24 | 🌐 Python | 📅 2022-09-26 - Only Vigil is truly vigilant about not allowing code that fails to pass programmatic specifications.
...
* [Fetlang](https://github.com/Property404/fetlang) ⭐ 1,494 | 🐛 10 | 🌐 C++ | 📅 2024-05-02 - Designed such that source code looks like poorly written fetish erotica.
...
* [Watson](https://github.com/genkami/watson) ⭐ 268 | 🐛 11 | 🌐 Go | 📅 2026-02-11 - Stack-based Turing-incomplete configuration files.
...
* [πfs](https://github.com/philipl/pifs) ⭐ 6,867 | 🐛 56 | 🌐 C | 📅 2019-12-31 - Pi-based storage system, store your data by searching a matching sequence in pi.
...
* [NoCode](https://github.com/kelseyhightower/nocode) ⭐ 64,734 | 🐛 4,636 | 🌐 Dockerfile | 📅 2024-08-07 - Secure and reliable applications. Write nothing; deploy nowhere.
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,269 | 🐛 538 | 🌐 Java | 📅 2024-07-15 - Simple FizzBuzz game implemented under the most strict enterprise standards.
...
* [Esofiles](https://github.com/graue/esofiles) ⭐ 106 | 🐛 6 | 🌐 C | 📅 2024-05-26 - The Esoteric Files Archive, an archive of implementations of esoteric programming languages and examples.
