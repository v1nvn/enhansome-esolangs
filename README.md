...
* [Vigil](https://github.com/munificent/vigil) ⭐ 3,032 | 🐛 26 | 🌐 Python | 📅 2022-09-26 - Only Vigil is truly vigilant about not allowing code that fails to pass programmatic specifications.
...
* [NoCode](https://github.com/kelseyhightower/nocode) ⭐ 65,264 | 🐛 4,711 | 🌐 Dockerfile | 📅 2024-08-07 - Secure and reliable applications. Write nothing; deploy nowhere.
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,646 | 🐛 545 | 🌐 Java | 📅 2024-07-15 - Simple FizzBuzz game implemented under the most strict enterprise standards.
...
* [MalbolgeLisp](https://github.com/kspalaiologos/malbolge-lisp) ⭐ 547 | 🐛 0 | 🌐 TeX | 📅 2025-08-05 - A Lisp interpreter in Malbolge Unshackled.
