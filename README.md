...
* [JSFuck](https://github.com/aemkei/jsfuck) ⭐ 8,579 | 🐛 38 | 🌐 JavaScript | 📅 2025-03-10 - Esoteric programming style based on the atomic parts of JavaScript.
...
* [πfs](https://github.com/philipl/pifs) ⭐ 6,888 | 🐛 56 | 🌐 C | 📅 2026-04-01 - Pi-based storage system, store your data by searching a matching sequence in pi.
...
* [NoCode](https://github.com/kelseyhightower/nocode) ⭐ 65,137 | 🐛 4,701 | 🌐 Dockerfile | 📅 2024-08-07 - Secure and reliable applications. Write nothing; deploy nowhere.
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,588 | 🐛 545 | 🌐 Java | 📅 2024-07-15 - Simple FizzBuzz game implemented under the most strict enterprise standards.
