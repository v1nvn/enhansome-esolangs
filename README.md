...
* [JSFuck](https://github.com/aemkei/jsfuck) ⭐ 8,585 | 🐛 38 | 🌐 JavaScript | 📅 2025-03-10 - Esoteric programming style based on the atomic parts of JavaScript.
...
* [Fetlang](https://github.com/Property404/fetlang) ⭐ 1,503 | 🐛 10 | 🌐 C++ | 📅 2024-05-02 - Designed such that source code looks like poorly written fetish erotica.
* [Monicelli](https://github.com/esseks/monicelli) ⭐ 1,379 | 🐛 20 | 🌐 C++ | 📅 2025-11-23 - Programming using Italian-like gibberish.
* [Jelly](https://github.com/DennisMitchell/jellylanguage) ⭐ 908 | 🐛 22 | 🌐 Python | 📅 2020-09-02 - Golfing language based on J.
...
* [πfs](https://github.com/philipl/pifs) ⭐ 6,895 | 🐛 56 | 🌐 C | 📅 2026-04-01 - Pi-based storage system, store your data by searching a matching sequence in pi.
...
* [NoCode](https://github.com/kelseyhightower/nocode) ⭐ 65,216 | 🐛 4,709 | 🌐 Dockerfile | 📅 2024-08-07 - Secure and reliable applications. Write nothing; deploy nowhere.
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,623 | 🐛 545 | 🌐 Java | 📅 2024-07-15 - Simple FizzBuzz game implemented under the most strict enterprise standards.
