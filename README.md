...
* [Fetlang](https://github.com/Property404/fetlang) ⭐ 1,498 | 🐛 10 | 🌐 C++ | 📅 2024-05-02 - Designed such that source code looks like poorly written fetish erotica.
...
* [FlipJump](https://github.com/tomhea/flip-jump) ⭐ 135 | 🐛 13 | 🌐 Text | 📅 2025-01-11 - 1 instruction: Flip a bit, then Jump. The simplest OISC.
...
* [πfs](https://github.com/philipl/pifs) ⭐ 6,883 | 🐛 56 | 🌐 C | 📅 2019-12-31 - Pi-based storage system, store your data by searching a matching sequence in pi.
...
* [NoCode](https://github.com/kelseyhightower/nocode) ⭐ 65,042 | 🐛 4,696 | 🌐 Dockerfile | 📅 2024-08-07 - Secure and reliable applications. Write nothing; deploy nowhere.
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,564 | 🐛 542 | 🌐 Java | 📅 2024-07-15 - Simple FizzBuzz game implemented under the most strict enterprise standards.
...
* [Esofiles](https://github.com/graue/esofiles) ⭐ 108 | 🐛 6 | 🌐 C | 📅 2024-05-26 - The Esoteric Files Archive, an archive of implementations of esoteric programming languages and examples.
