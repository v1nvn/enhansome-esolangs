# Awesome Esolangs [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) with stars
...
* [JSFuck](https://github.com/aemkei/jsfuck) ⭐ 8,563 | 🐛 38 | 🌐 JavaScript | 📅 2025-03-10 - Esoteric programming style based on the atomic parts of JavaScript.
* [Vigil](https://github.com/munificent/vigil) ⭐ 3,012 | 🐛 24 | 🌐 Python | 📅 2022-09-26 - Only Vigil is truly vigilant about not allowing code that fails to pass programmatic specifications.
...
* [Fetlang](https://github.com/Property404/fetlang) ⭐ 1,496 | 🐛 10 | 🌐 C++ | 📅 2024-05-02 - Designed such that source code looks like poorly written fetish erotica.
* [Monicelli](https://github.com/esseks/monicelli) ⭐ 1,377 | 🐛 20 | 🌐 C++ | 📅 2025-11-23 - Programming using Italian-like gibberish.
* [Jelly](https://github.com/DennisMitchell/jellylanguage) ⭐ 904 | 🐛 22 | 🌐 Python | 📅 2020-09-02 - Golfing language based on J.
* [Folders](https://github.com/rottytooth/Folders) ⭐ 385 | 🐛 1 | 🌐 C# | 📅 2021-12-20 - Code written with folders.
* [Watson](https://github.com/genkami/watson) ⭐ 269 | 🐛 11 | 🌐 Go | 📅 2025-12-20 - Stack-based Turing-incomplete configuration files.
* [Charcoal](https://github.com/somebody1234/Charcoal) ⭐ 226 | 🐛 1 | 🌐 Python | 📅 2024-12-05 - Concise language for sketching ASCII art.
* [FlipJump](https://github.com/tomhea/flip-jump) ⭐ 131 | 🐛 13 | 🌐 Text | 📅 2025-01-11 - 1 instruction: Flip a bit, then Jump. The simplest OISC.
* [FreakC](https://github.com/FreakC-Foundation/FreakC) ⭐ 130 | 🐛 1 | 🌐 Batchfile | 📅 2025-12-04 - Full-blown programming language with NSFW contents and memes.
* [Electra](https://github.com/DolphyWind/Electra-Lang) ⭐ 99 | 🐛 1 | 🌐 C++ | 📅 2025-11-22 - Code like an electrician.
...
* [Japt](https://github.com/ETHproductions/japt) ⭐ 75 | 🐛 21 | 🌐 JavaScript | 📅 2021-05-27 - Reduced JavaScript for golfing.
...
* [Brackets](https://github.com/kvbc/brackets) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2021-06-19 - Language made of brackets, a lot of brackets.
* [Dots](https://github.com/josconno/dots) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2021-03-22 - A turing-complete language using "." symbol only.
* [78](https://github.com/oatmealine/78) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2020-04-07 - A single-character command language focused around the numbers 7 and 8.
* [Mindfck](https://github.com/angrykoala/mindfck) ⭐ 6 | 🐛 1 | 🌐 Go | 📅 2025-03-17 - High level language that transpiles to Brainfuck.
* [Ni](https://github.com/DeybisMelendez/ni) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2020-07-28 - Brainfuck-based with more helpful instructions.
...
* [πfs](https://github.com/philipl/pifs) ⭐ 6,860 | 🐛 56 | 🌐 C | 📅 2019-12-31 - Pi-based storage system, store your data by searching a matching sequence in pi.
...
* [NoCode](https://github.com/kelseyhightower/nocode) ⭐ 64,685 | 🐛 4,633 | 🌐 Dockerfile | 📅 2024-08-07 - Secure and reliable applications. Write nothing; deploy nowhere.
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,187 | 🐛 538 | 🌐 Java | 📅 2024-07-15 - Simple FizzBuzz game implemented under the most strict enterprise standards.
...
* [MalbolgeLisp](https://github.com/kspalaiologos/malbolge-lisp) ⭐ 530 | 🐛 0 | 🌐 TeX | 📅 2025-08-05 - A Lisp interpreter in Malbolge Unshackled.
...
* [Esofiles](https://github.com/graue/esofiles) ⭐ 107 | 🐛 6 | 🌐 C | 📅 2024-05-26 - The Esoteric Files Archive, an archive of implementations of esoteric programming languages and examples.
